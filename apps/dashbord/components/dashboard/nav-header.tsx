...
export default function NavHeader() {
  ...
  let acc = baseHref;
  return (
    <header className="sticky top-0 z-0 flex h-17 w-full min-w-0 shrink-0 items-center gap-2 overflow-x-hidden bg-background/80 backdrop-blur transition-[width,height] ease-linear supports-backdrop-filter:bg-background/60 group-has-data-[collapsible=icon]/sidebar-wrapper:h-12">
